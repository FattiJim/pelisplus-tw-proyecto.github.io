...
$con= mysqli_connect(
  'localhost', 'root', '7556_30Kth*','cinema'
);
...
if(!$con) {
  die('¡Base de datos NO conextada!');
    ...
    class Conexion
    {
        ...
        //Serie de filtros para almacenar en base de datos, para que no haya errores por caracteres especiales

  ...
  <body>
    ...
    <div class="container">
      <div class="row p-4">
        <div class="col-md-5">
          <div class="card">
            <div class="card-body">
              ...
              <form id="peliculas-form" novalidate>
                <div class="form-group">
                  <input class="form-control" type="text" id="titulo" placeholder="Nombre de la pelicula" minlength="5" maxlength="100" required>
                  <span class="error" aria-live="polite"></span>
                </div>
                <div class="form-group">
                  <input class="form-control" type="text" id="duracion" placeholder="Duracion 0h 00m" required>
                  <span class="error" aria-live="polite"></span>
                </div>
                <div class="form-group">
                ...
                <input type="hidden" id="peliculasId">
        ...
        <!-- TABLA  -->
        <div class="col-md-7">
          <div class="card my-4" id="peliculas-result">
            <div class="card-body">
              <!-- RESULTADO -->
              <ul id="container"></ul>
            </div>
